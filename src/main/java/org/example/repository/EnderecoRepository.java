...
public class EnderecoRepository extends _BaseRepositoryImpl<Endereco> {
    ...
    @Query("INSERT INTO GS_ENDERECO (RUA, NUMERO, COMPLEMENTO, CEP, BAIRRO, CIDADE, ESTADO, PAIS) VALUES (?, ?, ?, ?, ?, ?, ?, ?)")
    public void create(Endereco endereco) {
        try {
            QueryProcessor.executeAnnotatedMethod(this, "create", endereco.getRua(), endereco.getNumero(),
